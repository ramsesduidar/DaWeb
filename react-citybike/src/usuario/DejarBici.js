...
function DejarBici({idUsuario, idEstacion, huecosLibres, activeAlquiler, onSuccess,  onError}) {
  ...
  return (
    <>
    <Button variant="primary" disabled={!huecosLibres || !activeAlquiler} onClick={() => setModalShow(true)}>
    Dejar Bici +
    </Button>
    <Modal
      show={modalShow}
